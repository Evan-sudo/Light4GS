...
class ModelHiddenParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.hash_weight = 0.0001 # smoothness of hash hexplane
...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.entropy_lr_init = 0.00016
        self.entropy_lr_final = 0.000016
        ...
        self.densify_until_iter = 15_000   # maximum number of iterations for densification
